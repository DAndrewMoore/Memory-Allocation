...
void trivialFIFO(vector<processStruct> pVec, string seed, int maxMem = 20000001, int processors = 64){
    ...
    printf("%s,", seed.c_str());
    printf("%f,", (float)maxMem);
    printf("trivial,");
    printf("%f,", ((float)total_malloc_time + total_free_time)/CLOCKS_PER_SEC);
    printf("%f,", ((float)total_malloc_time)/CLOCKS_PER_SEC);
...
int main(int argc, char** argv) {
    ...
    printf("seed, maxMem,manager, total, malloc, free\n");
